...
# # SetInput
folder_path_Saturation = '/workspace/data/AllMapsInOneFolder/decompressed/Saturation/'
folder_path = '/workspace/data/AllMapsInOneFolder/decompressed'

# Create output folder
output_AverageSaturation_folder = os.path.join(folder_path, 'AverageS')

# Ensure output folder exist
os.makedirs(output_AverageSaturation_folder, exist_ok=True)

# Use os.listdir to get all files in the directory
files_in_directory = os.listdir(folder_path_Saturation)
...
for tif_file in tif_files:
    file_path = os.path.join(folder_path_Saturation, tif_file)
    ...
    with rasterio.open(file_path) as src:
        ...
        output_file_path = os.path.join(output_AverageSaturation_folder, tif_file)
